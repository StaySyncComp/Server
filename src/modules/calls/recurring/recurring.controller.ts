...
export const createRecurringCall = asyncHandler(
...
export const getRecurringCalls = asyncHandler(
...
export const deleteRecurringCall = asyncHandler(
...
export const updateRecurringCall = asyncHandler(
  async (req: ExtendedRequest, res: Response): Promise<any> => {
    const { id } = req.params;
    const {
      title,
